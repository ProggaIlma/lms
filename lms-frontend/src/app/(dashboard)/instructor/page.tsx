  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          { label: "My Courses",   value: "0", icon: "📚", color: "bg-indigo-50 text-indigo-600" },
          { label: "Students",     value: "0", icon: "👥", color: "bg-green-50 text-green-600" },
          { label: "Revenue",      value: "$0", icon: "💰", color: "bg-amber-50 text-amber-600" },
        ].map((stat) => (
      ...
      <div className="bg-white rounded-xl border border-surface-200 p-6">
        ...
        <div className="flex flex-wrap gap-3">
          <Link href="/instructor/courses/create" className="btn-primary btn">
            Create Course
          </Link>
          <Link href="/instructor/courses" className="btn-secondary btn">
            My Courses
          </Link>
          <Link href="/instructor/analytics" className="btn-secondary btn">
            View Analytics
          </Link>
        </div>
      </div>
