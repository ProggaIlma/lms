        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-sm text-surface-400 mt-1">
              {search || statusFilter ? "Try adjusting your filters" : "No courses created yet"}
            </p>
          </div>
        ) : (
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-2">
                      ...
                      <select
                        ...
                        className="text-xs border border-surface-200 rounded-lg px-2 py-1 text-surface-600 focus:outline-none focus:ring-2 focus:ring-primary-500"
                      >
                        <option value="DRAFT">Draft</option>
                        <option value="PUBLISHED">Published</option>
                        <option value="ARCHIVED">Archived</option>
